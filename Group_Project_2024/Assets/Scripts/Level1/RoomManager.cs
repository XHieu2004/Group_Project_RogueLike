...
public class RoomManager : MonoBehaviour
{
    ...
    private int enemyCount1; // Total enemies in the room
    private int enemyCount2; // Total enemies in the room
    private int enemyCount3; // Total enemies in the room
    private int enemyCount4; // Total enemies in the room
    private int enemyCount5; // Total enemies in the room
    private int enemyCount6; // Total enemies in the room
